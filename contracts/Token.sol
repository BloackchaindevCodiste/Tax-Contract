...
contract WhiteHatDAOToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    ...
    function _transfer(address from, address to, uint256 amount) internal override virtual {
        ...
        require(!(restrictedUser[from] || restrictedUser[to]) ,"You are restricted for transfer");
        if (
            from != owner() &&
            to != owner() &&
            to != address(0) &&
